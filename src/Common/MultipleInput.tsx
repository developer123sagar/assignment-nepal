  ...
  return (
    <div className="tags-input-container">
      <input
        ...
        className="form-control w-full bg-white-1 py-3 pl-2 rounded placeholder:text-gray-500 border border-gray-200 mb-2"
        value={inputValue}
      ...
      <div className="flex flex-wrap gap-2">
        {tags.length > 0 &&
          tags.map((tag, index) => (
            <div
              key={index}
              className="bg-blue-500 text-white-1 px-3 py-1 rounded-full flex items-center gap-2"
            >
              {tag}
              <FaTimes
